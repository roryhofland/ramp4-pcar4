...
const serviceTypeOptions = reactive([
    {
        ...
        label: iApi.$vApp.$t('wizard.layerType.esriFeature')
    },
    {
        value: LayerType.MAPIMAGE,
        label: iApi.$vApp.$t('wizard.layerType.esriMapImage')
    },
    {
        value: LayerType.TILE,
        label: iApi.$vApp.$t('wizard.layerType.esriTile')
    },
    {
        value: LayerType.IMAGERY,
        label: iApi.$vApp.$t('wizard.layerType.esriImagery')
    },
    {
        value: LayerType.WMS,
        label: iApi.$vApp.$t('wizard.layerType.ogcWms')
    },
    {
        value: LayerType.WFS,
        label: iApi.$vApp.$t('wizard.layerType.ogcWfs')
    }
]);
...
const fileTypeOptions = reactive([
    {
        ...
        label: iApi.$vApp.$t('wizard.fileType.geojson')
    },
    {
        value: LayerType.SHAPEFILE,
        label: iApi.$vApp.$t('wizard.fileType.shapefile')
    },
    { value: LayerType.CSV, label: iApi.$vApp.$t('wizard.fileType.csv') }
]);
