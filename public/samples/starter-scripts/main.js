...
// window.debugInstance = rInstance2;

// rInstance2.fixture.addDefaultFixtures().then(() => {
//     rInstance2.panel.open('legend-panel');
// });

// rInstance2.$element.component('WFSLayer-Custom', {
//     props: ['identifyData'],
//     template: `
//         <div>
//             <span>This is an example template that contains an image.</span>
...
// rInstance2.$element.component('Water-Quantity-Template', {
//     props: ['identifyData'],
//     template: `
//         <div style="align-items: center; justify-content: center; font-size: .875rem; font-family: Arial, sans-serif;">
//             <div v-html="renderHeader()" />
...
//     if (rInstance2.language === 'en') {
//         rInstance2.setLanguage('fr');
//     } else {
//         rInstance2.setLanguage('en');
//     }
//     document.getElementById('instance-language').innerText =
//         rInstance2.language;
// }

// function animateToggle2() {
//     if (rInstance2.$vApp.$el.classList.contains('animation-enabled')) {
//         rInstance2.$vApp.$el.classList.remove('animation-enabled');
//     } else {
//         rInstance2.$vApp.$el.classList.add('animation-enabled');
//     }
//     document.getElementById('animate-status').innerText =
//         'Animate: ' + rInstance2.animate;
// }
